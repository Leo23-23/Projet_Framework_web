  ...
  <div class="detail">
    <div class="detail-view" v-if="show">
      ...
      <div v-if="pokemon" class="data">
        <h2>{{ pokemon.name }}</h2>
        <div class="property">
          <div class="left">Expérience de base</div>
          <div class="right">{{ pokemon.base_experience }} XP</div>
        </div>
        <div class="property">
          <div class="left">Hauteur</div>
      ...
      <h2 v-else>Le Pokemon est introuvable</h2>
  ...
  .detail {
    ...
    .detail-view {
      ...
      .image {
        ...
        border-radius: 50%;
        overflow: hidden;
        box-shadow: 0 15px 30px rgba(234, 238, 5, 0.966),
                    0 10px 10px rgba(92, 93, 4, 0.5);
      }
      h2 {
